...
기구축 k3s 환경의 **옵저버빌리티**를 맡으면서 지표를 해석하려면 그 아래 층까지 알아야 한다고 판단해, **가상화 · 네트워크부터 Terraform까지** 한 층씩 직접 세웠습니다.
그렇게 세운 환경에서 문제의 원인은 metric · log · trace로 좁히고, 용량은 SLO를 먼저 정한 **부하 테스트로 실측**했습니다.
{:.lead}
