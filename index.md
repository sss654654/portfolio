...
노트북 한 대로 쿠버네티스 · CI/CD · 모니터링 · 방화벽을 세우고, 그 위에 대기열 예매 서비스를 인터넷에 운영하며 1만 명 부하 테스트를 에러 없이 통과했습니다.
회사에서는 k3s 모니터링을 구축하고, profile로 찾은 함수를 개발팀이 고쳐 메모리를 78% 줄였습니다.
...
* **2026.03 – 06** — [semiai 인프라팀](/projects/semiai/) — 기구축 k3s 위 관측 담당 · 인프라·앱 대시보드, Go 백엔드 네 신호 계측 — profile로 찾은 함수를 개발팀이 수정해 메모리 78% 감소
