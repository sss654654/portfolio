...
- **개발계 네트워크 계층이 코드 한 벌로 남았습니다** — VPC·서브넷 6개·라우트 테이블 4개·보안그룹 5개·엔드포인트 5개·GitLab EC2
...
- **CI/CD · EKS 구축과 배포계는 팀원 몫이었습니다** — 파이프라인과 클러스터를 직접 세우지 않았고, 부하는 개발계에서 동작 확인까지만 했습니다. 클러스터 구축은 [홈랩](/homelab/onprem/)에서, EKS 구축은 [클라우드](/homelab/cloud/)에서 채웠습니다
