...
[이력서 PDF 내려받기](/assets/subinhong-resume.pdf){:.hl-more}
...
**[cloudwave 클라우드 부트캠프](/projects/cgv/) · CJ 올리브네트웍스** · 2025.06 – 09
{:.hl-more}

5인 팀의 CGV 예매 대기열 시스템에서 개발계 네트워크 계층(Terraform)과 대기열 백엔드(Spring Boot)를 맡았습니다.
