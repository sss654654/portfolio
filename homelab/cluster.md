...
- 파드 네트워크·로드밸런서·인그레스·스토리지가 **기본값 대신 직접 고른 것으로** 서 있습니다
- 워크로드마다 갈린 **디스크 10장이 정적 PV로** 붙어 있습니다
- 노드가 파드에 내줄 수 있는 몫이 **노드당 5081Mi**로 정해졌습니다 — 물리 7941Mi에서 k3s 2Gi, OS 512Mi, 퇴출 기준선 300Mi를 뺀 값입니다
- 뚜껑을 닫은 채 **상시 가동**합니다
