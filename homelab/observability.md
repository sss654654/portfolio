...
| 항목 | 선택 | 이유 |
|---|---|---|
| metric 저장소 | **Mimir distributed** — ingester dev 3대 · stg 1대 | ingester 1대면 중단 시 최근 2시간 metric 소실 — dev는 분산, stg는 하루 환경이라 1대 |
...
| stg 2.5만 명 입장 반영 **97.445%** — 브로커 유휴 · 메시지 대기 1.852초 | 요청의 96%인 폴링마다 접근 로그 1줄 — Loki **초당 4,256줄** · 수집기 노드당 0.5코어 · booking 노드 런큐 **3.30초/초** | 성공 폴링 로그 제외 → 100.000% · 741줄/초 · 런큐 0.26 |
{:.hl-tbl}
