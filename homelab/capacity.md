...
달랐던 두 가지는 판 도중 바로잡았습니다 — 전원이 같은 밀리초에 누르던 시작·오픈
시각을 흩었고, 원인이 안 가려지는 연결 실패 때문에 부하 생성기를 집 밖(클라우드)으로
옮겼습니다. 옮기고 보니 집 회선이 서버 부하를 40% 낮춰 재고 있었습니다.
...
| 입장 경로 1초 | 순번 조회 p99 — 평상 0.36초 · 오픈 뒤 30초 3.76초 | 오픈 구간만 초과 |
