...
부하를 10,000명까지 올리며 **합격선을 벗어난 자리만** 스펙을 올렸습니다. 정원 하나만
반대입니다 — 2로는 뒷단이 놀아 잴 수가 없고(뒷단 부하 = 확정/초 = 정원 ÷ 체류),
500에서도 자원이 절반 아래라 **1,000**으로 올렸습니다. 마지막 구매자 대기가
7분 17초 → 3분 7초로 줄었습니다.

아래는 그 확정 스펙으로 돌린 판 — **인원 10,000 · 정원 1,000** — 의 화면이고,
캡션은 문제 → 조치 → 이 판의 결과 순서입니다.
