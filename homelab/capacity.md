...
부하 생성기는 집 데스크탑(WSL)의 k6였습니다. 이 장비의 상한이 10,000명이라는 것은
알고 시작했습니다 — 1만 명을 만드는 데 약 4코어·4GB가 들어, 그 위는 장비가 못 담습니다.
그 상한 안에서 인원 계단과 정원 계단을 밟으며 값 일곱을 실측으로 바꿨습니다.
앞단은 인원이 정하고, 뒷단은 정원이 정합니다.
...
(작성 중 — 10,000명 판 실측과 30,000명 판으로 채웁니다)
