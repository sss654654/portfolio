...
| 증상 | 원인 | 조치 |
|---|---|---|
| **오픈 순간 지연이 첫 판에서만 10–20초** | **booking JVM 웜업**<br>93분 논 파드가 오픈에 JIT 컴파일 CPU **111초** — 요청 처리와 2코어를 나눠 씀 | **측정 절차에 웜업 판 추가**<br>파드 나이 게이트는 유휴 파드에서 무효<br>데워진 뒤 회차 0.94초 · 현황판 0.1초 |
